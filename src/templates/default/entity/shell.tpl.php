    ...
    if ($owner = $object->getOwner()) {
        ?>
            ...
            if (preg_match('@\\\\([\w]+)$@', get_class($object), $matches)) {
                ...
                <div
                    class="col-md-10 col-md-offset-1 <?php echo $object->getMicroformats2ObjectType() ?> idno-<?php echo $object->getContentTypeCategorySlug() ?> idno-status-<?php echo strtolower($object->access) ?> idno-object idno-content">
